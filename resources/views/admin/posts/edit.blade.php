    ...
    <div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
        ...
        <form action="{{route('admin.posts.update', $post->id )}}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{old('title',$post->title)}}" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                ...
                dark:focus:border-blue-500" name="title">
                @error('title')
        ...
        <textarea id="message" name="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50
